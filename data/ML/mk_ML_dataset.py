...
# Transpose T_input to get the shape (n_samples, 180*6)
T_input = T_input.reshape(n_samples, -1)

# Save the datasets
np.save('all_sequence/multi_feature/T_input.npy', T_input)
np.save('all_sequence/multi_feature/T_core.npy', T_core)
